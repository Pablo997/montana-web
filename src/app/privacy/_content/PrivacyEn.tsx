/**
 * English body of `/privacy`. Pure JSX so the structure (tables,
 * `<strong>`, links) stays trivial to review — no `t.rich` indirection
 * per paragraph for what is effectively a long-form document.
 *
 * Locale dispatch happens one level up in `page.tsx`. To translate,
 * duplicate this file as `PrivacyXx.tsx`, rewrite the prose, and add
 * an `xx` branch to the dispatcher.
 */
  ...
  return (
    <>
      ...
      <section>
        ...
        <table className="legal__table">
          ...
          <tbody>
            ...
            <tr>
              <td>
                Incidents you create (type, severity, title, description,
                coordinates, elevation, photos)
              </td>
      ...
      <section>
        ...
        <ul>
          <li>
            Real-time location tracking. Geolocation is only read in your
            browser when you explicitly trigger it.
          </li>
          <li>
            Contacts, calendar, microphone, or any other device-level
            permission.
          </li>
          <li>
            Cross-site tracking. We use no third-party advertising cookies
            or fingerprinting.
          </li>
          <li>
            Special categories of data under art. 9 GDPR (health, religion,
            ethnicity, etc.).
          </li>
          <li>
            <strong>Photo EXIF metadata.</strong> When you attach a photo to
            an incident, your browser re-encodes it before upload. The
            re-encoded file we receive has <strong>no EXIF metadata</strong>{' '}
            — the GPS coordinates, camera model, date and other fields your
            phone embeds by default are stripped client-side and never
            reach our servers. The only location data we store is the map
            pin you placed yourself.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Supabase (EU region)</strong> — database, auth, object
            storage. Data Processing Agreement executed.
          </li>
          <li>
      ...
      <section>
        ...
        <ul>
          <li>
            Account data: kept while your account exists. Deleted within 30
            days of account deletion request.
          </li>
          <li>
            Incidents you authored: kept while relevant, or up to 12 months
            after expiry.
          </li>
          <li>Server logs: up to 30 days.</li>
          <li>
            Votes: kept as anonymized counters; user links removed on
            account deletion.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <strong>Restriction</strong>: pause processing while disputing
            data accuracy.
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          the target incident id, the reason you selected and any
          free-text detail you typed, linked to your account. This data is
          used solely to moderate the service (remove abusive or false
          content) and is processed on the legal basis of{' '}
          <strong>legitimate interest</strong> (art. 6(1)(f) GDPR) —
          keeping the community safe. Reports are retained for up to 12
          months and then deleted. Only the reporter and our moderation
          team can read them; reported users do not see who reported them.
        </p>
      </section>
      ...
      <section>
        <h2>9. Children</h2>
        <p>
          Montana is not directed to children under 14. We do not knowingly
          collect personal data from anyone under 14 without parental
          consent, as required by art. 7 LOPDGDD.
        </p>
      </section>
