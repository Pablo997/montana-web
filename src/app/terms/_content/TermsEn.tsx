/**
 * English body of `/terms`. See `PrivacyEn.tsx` for the rationale on
 * keeping legal documents as inline JSX rather than translation strings.
 */
  ...
  return (
    <>
      ...
      <section>
        ...
        <p>
          Mountains are dangerous. The information on Montana is
          crowd-sourced and may be incomplete, outdated or wrong. Do{' '}
          <strong>not</strong> rely on it as your sole source when planning
          routes, evacuations or emergency decisions. Always consult
          official sources (park authorities, rescue services, weather
          bulletins) and use your own judgement. You are fully responsible
          for your safety.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            One person, one account. Multi-accounting to manipulate votes
            is prohibited and leads to account removal.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            Does not violate any applicable law, including copyright (use
            only photos you took or have rights to).
          </li>
          <li>
            Does not spam, advertise commercial services, or abuse the
            system.
          </li>
        </ul>
        <p>
          We apply automatic moderation (rate limits, community-vote
          thresholds, report-count auto-hide) and may remove content or
      ...
      <section>
        ...
        <p>
          Any signed-in user can report an incident that violates these
          rules using the <em>Report this incident</em> link on the
          incident panel. Reports are capped at 10 per user per 24 hours
          to deter brigading. When an incident accumulates several
          independent reports it is automatically hidden from the map
          pending human review; if our review confirms the violation the
          content is permanently removed and, depending on severity, the
          author&apos;s account may be restricted or terminated.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Montana is provided &quot;as is&quot; and &quot;as
          available&quot;. We may throttle, pause, change or discontinue
          features without prior notice. We are not liable for any damage
      ...
      <section>
        ...
        <p>
          ...
          Continuing to use Montana after a change means you accept the
          new terms.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          conflict-of-law rules. Disputes are to be resolved in the courts
          of the user&apos;s habitual residence when consumer protection
          laws so require; otherwise, in the courts of the province of
          Alicante, Spain.
        </p>
      </section>
    </>
