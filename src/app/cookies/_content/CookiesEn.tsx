/**
 * English body of `/cookies`. See `PrivacyEn.tsx` for the rationale on
 * keeping legal documents as inline JSX.
 */
    ...
    <>
        ...
        <table className="legal__table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                Remembers that you&apos;ve seen the legal notice so we
                don&apos;t show it again
              </td>
              <td>Strictly necessary</td>
      ...
      <section>
        ...
        <p>
          ...
          without persisting personal identifiers. Under the AEPD guidance
          of July 2023, cookieless aggregate measurement of this kind
      ...
      <section>
        ...
        <p>
          Map tiles are served by <strong>MapTiler</strong>. Their servers
          see your IP and the tiles you request, but this traffic does not
          set any cookies in your browser. Supabase storage serves
          user-uploaded photos the same way.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          If we ever add non-essential cookies in the future, we will show
          a proper consent banner before setting them and give you
          granular controls.
        </p>
      </section>
